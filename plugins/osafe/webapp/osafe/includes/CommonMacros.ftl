...
<#macro navBar parentCategory category levelUrl levelValue listIndex listSize>
  ...
  <#if levelValue?has_content && levelValue="1">
	  ...
	  <#assign megaMenuProductCategoryContentList = delegator.findByAnd("ProductCategoryContent", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId" , category.productCategoryId?string, "prodCatContentTypeId" , "PLP_ESPOT_MEGA_MENU")) />
	  <#if megaMenuProductCategoryContentList?has_content>
	   ...
	   <#assign megaMenuContent = prodCategoryContent.getRelatedOne("Content")/>
	  ...
	  <#assign productCategoryMemberList = delegator.findByAnd("ProductCategoryMember", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("productCategoryId" , category.productCategoryId?string)) />
    ...
    <li class="${levelClass} ${itemIndexClass} ${category.productCategoryId!}">
        ...
        <#if subCatList?has_content>
          ...
          <#list subCatList as subCat>
            <#assign subCategoryRollups = subCat.getRelated("CurrentProductCategoryRollup")/>
...
<#macro renderCrumb category>
      <#assign productCategoryMembers = category.getRelated("ProductCategoryMember")!"" />
