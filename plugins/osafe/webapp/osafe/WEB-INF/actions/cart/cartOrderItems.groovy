...
List<GenericValue> productAttributes = new ArrayList();
if(UtilValidate.isNotEmpty(product))
{
	productAttributes = product.getRelated("ProductAttribute");
}

List<GenericValue> virtualProductAttributes = new ArrayList();
if(UtilValidate.isNotEmpty(virtualProduct))
{
	virtualProductAttributes = virtualProduct.getRelated("ProductAttribute");
}
