...
partyDetailList = new ArrayList();
partyDetailExistsList = new ArrayList();
          ...
          {        
            ...
            if(UtilValidate.isNotEmpty(latestPartyGeoPoint)) 
            {
                ...
                if (latestGeoPoint.dataSourceId == dataSourceId && distance <= redius) 
                {
                    ...
                    storeLocationLocations = EntityUtil.getRelated("PartyContactMech", storeLocationLocations);
                    ...
                    if (UtilValidate.isNotEmpty(storeLocationLocations)) 
                    {
                    	...
                    	storeAddress = storeLocationLocation.getRelatedOne("PostalAddress");
                        context.storeAddress =storeAddress;
                    ...
                    storeTelephoneLocations = EntityUtil.getRelated("PartyContactMech", storeTelephoneLocations);
                    ...
                    if (UtilValidate.isNotEmpty(storeTelephoneLocations)) 
                    {
                    	...
                    	storePhone = storeTelephoneLocation.getRelatedOne("TelecomNumber");
                        context.storePhone =storePhone;
                    ...
                    partyContent = party.getRelated("PartyContent");
                    ...
                    if (UtilValidate.isNotEmpty(storeHours)) 
                    {
                        ...
                        content = storeHour.getRelatedOne("Content");
                    ...
                    if (UtilValidate.isNotEmpty(storeNotices)) 
                    {
                        ...
                        content = storeNotice.getRelatedOne("Content");
                        if (UtilValidate.isNotEmpty(content))
                        {
                    ...
                    if (UtilValidate.isNotEmpty(storeContentSpots)) 
                    {
                        ...
                        content = storeContentSpot.getRelatedOne("Content");
                        if (UtilValidate.isNotEmpty(content))
                        {
