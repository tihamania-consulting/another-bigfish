...
if (UtilValidate.isNotEmpty(userLogin)) 
{
    ...
    partyContactDetailByPurpose = delegator.findByAnd("PartyContactDetailByPurpose",UtilMisc.toMap("partyId", partyId), UtilMisc.toList("-fromDate"));
    ...
    if (UtilValidate.isNotEmpty(contactMechBilling))
    {
	    ...
	    postalAddressData = contactMechBilling.getRelatedOne("PostalAddress");
        ...
        contactMechLinkList = delegator.findByAnd("ContactMechLink", UtilMisc.toMap("contactMechIdFrom", contactMechBilling.contactMechId));
