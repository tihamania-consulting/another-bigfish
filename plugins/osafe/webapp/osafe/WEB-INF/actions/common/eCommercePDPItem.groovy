...
if(UtilValidate.isNotEmpty(productId)) 
{
  ...
  if (UtilValidate.isNotEmpty(product)) 
  {
    ...
    /*virtualProductPrices = delegator.findByAnd("ProductPrice", UtilMisc.toMap("productId", productId, "currencyUomId", cart.getCurrency(), "productStoreGroupId", "_NA_","productPricePurposeId","PURCHASE"), UtilMisc.toList("-fromDate"));
    ...
    //Instead just pulling the pricing directly from DB for plp type item displays (Complement, Accessory and  Recently Viewed)
    recurringProductPrices = delegator.findByAnd("ProductPrice", UtilMisc.toMap("productId", productId, "currencyUomId", cart.getCurrency(), "productStoreGroupId", "_NA_","productPricePurposeId","RECURRING_CHARGE"), UtilMisc.toList("-fromDate"));
