...
productScrollerUrlList = new ArrayList();
...
for (SolrIndexDocument productInfo : productDocumentList)
{
	...
	{
		productSelectableFeatureAndAppl = delegator.findByAnd("ProductFeatureAndAppl", UtilMisc.toMap("productId",productInfoId, "productFeatureTypeId", plpFacetGroupVariantSticky, "productFeatureApplTypeId", "SELECTABLE_FEATURE", "description", featureValueSelected), UtilMisc.toList("sequenceNum"));
