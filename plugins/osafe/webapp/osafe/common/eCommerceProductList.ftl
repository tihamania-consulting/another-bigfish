...
<#if currentProductCategory?has_content>
  <#assign categoryContentList = currentProductCategory.getRelated("ProductCategoryContent")/>
  ...
  <#if categoryContentList?has_content>
   ...
   <#if pageTopCategoryContentList?has_content>
	   ...
	   <#assign pageTopContent = pageTopCategoryContent.getRelatedOne("Content")/>
   ...
   <#if pageEndCategoryContentList?has_content>
	   ...
	   <#assign pageEndContent = pageEndCategoryContent.getRelatedOne("Content")/>
