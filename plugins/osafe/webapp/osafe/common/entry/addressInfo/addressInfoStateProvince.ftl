...
<#if parameters.fbLocationCountry?has_content> 
	<#assign fbUserCountryList = delegator.findByAnd("Geo", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("geoName" , parameters.fbLocationCountry, "geoTypeId", "COUNTRY"))/>
...
<#if parameters.fbLocationState?has_content> 
	<#assign fbUserStateList = delegator.findByAnd("Geo", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("geoName" , parameters.fbLocationState))/>
