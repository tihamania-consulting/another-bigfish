 ...
 <#if currentProduct?exists>
  ...
  function updateImageTextSize(idx) 
  {
  		if(jQuery('#fontSize_' + idx).length)
        {
	  		...
	  		var updateFont = "20";
	  		<#assign fontSizeEnums = delegator.findByAnd("Enumeration", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("enumTypeId", "FONT_SIZE"))/>
  ...
  function updateImageTextFont() 
  {
  		if(jQuery('#js_fontEnum').length)
  		{
	  		...
	  		<#assign fontFamilyEnums = delegator.findByAnd("Enumeration", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("enumTypeId", "FONT_FAMILY"))/>
	      	<#if fontSizeEnums?has_content>
  ...
  function updateImageTextAlignment() 
  {
  		if(jQuery('#js_textAlign').length)
  		{
	  		...
	  		<#assign textAlignEnums = delegator.findByAnd("Enumeration", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("enumTypeId", "TEXT_ALIGN"))/>
