    ...
    function validateCart()
    {
        ...
        <#if shoppingCart?has_content>
            ...
            <#list shoppingCartItems as shoppingCartItem>
                ...
                <#assign productName = Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(shoppingCartItem.getProduct(), "PRODUCT_NAME", locale, dispatcher, "html")!"" >
                <#assign productQty = 0>
                ...
                <#assign productAttributes = product.getRelated("ProductAttribute")!"" />
