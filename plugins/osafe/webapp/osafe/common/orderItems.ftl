        ...
        <table id="order_display" class="standardTable" summary="CurrentOrder_TABLE_SUMMARY">
            ...
            <#list orderItems as orderItem>
              ...
              <#if orderItem.orderId?exists && orderItem.orderId?has_content >
              	<#assign shipGroupAssoc = Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(delegator.findByAnd("OrderItemShipGroupAssoc", {"orderId": orderItem.orderId, "orderItemSeqId": orderItem.orderItemSeqId}))/>
                  ...
                  <#if shipGroup?has_content>
                      ...
                      <#if orderHeader?has_content && (orderHeader.statusId == "ORDER_COMPLETED" || orderItem.statusId == "ITEM_COMPLETED") >
                          ...
                          <#if shipDate?has_content>
                              <#assign shipDate = shipDate?string('dd/MM/yyyy')!""/>
                          </#if>
                      </#if>
              ...
              <#assign productImageUrl = Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(product, "SMALL_IMAGE_URL", locale, dispatcher , "string", "string")?if_exists>
            ...
            <#assign availability = uiLabelMap.InStockLabel>
                <tr>
                    ...
                    <td class="description <#if !orderItem_has_next>lastRow</#if>">
                        <dl>
                            ...
                            <dd class="description">
			                 ...
			                 <#assign productFeatureAndAppls = product.getRelated("ProductFeatureAndAppl") />
                    ...
                    <#if orderHeader?has_content>
                      <#assign status = orderHeader.getRelatedOne("StatusItem") />
