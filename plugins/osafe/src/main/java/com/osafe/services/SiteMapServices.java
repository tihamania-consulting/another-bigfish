...
public class SiteMapServices {
    ...
    public static Map buildSiteMap(DispatchContext dctx, Map<String, ?> context) 
    {
        ...
        try 
        {
                        ...
                        if (UtilValidate.isNotEmpty(product)) 
                        {
                            ...
                            if ("N".equals(isVariant)) 
                            {
                                ...
                                if (ProductWorker.isSellable(product)) 
                                {
                                    ...
                                    {
                                       List<GenericValue> lProductFeatureAndAppl = delegator.findByAnd("ProductFeatureAndAppl",UtilMisc.toMap("productId", product.getString("productId"),"productFeatureTypeId",SITEMAP_VARIANT_FEATURES.toUpperCase(),"productFeatureApplTypeId","SELECTABLE_FEATURE"), null, true);
            ...
            xContentXrefs = delegator.findByAnd("XContentXref", UtilMisc.toMap("contentTypeId", "BF_STATIC_PAGE","productStoreId", productStoreId), null, true);
    ...
    private static void createFriendlyMapNode (String URL,ProductContentWrapper productContentWrapper,CategoryContentWrapper categoryContentWrapper,CategoryContentWrapper parentCategoryContentWrapper,String featureDescription, String contentSeoFriendlyName) {
    	...
    	try {
        	...
        	if (productContentWrapper != null)
        	{
        		...
        		{
        			productName = productContentWrapper.get("PRODUCT_NAME", "html").toString();
        		}
        	}
        	...
        	if (parentCategoryContentWrapper !=null)
        	{
        		...
        		{
        			parentCategoryName = parentCategoryContentWrapper.get("CATEGORY_NAME", "html").toString();
        		}
        	}
        	...
        	if (categoryContentWrapper !=null)
        	{
        		...
        		{
        			categoryName = categoryContentWrapper.get("CATEGORY_NAME", "html").toString();
        		}
        	}
