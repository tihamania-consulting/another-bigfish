...
public class CommandContext {
    ...
    private Map<String, String> filterGroupsDescriptions = new HashMap();
    private Map<String, String> filterGroupsIds = new HashMap();
    private Map<String, String> filterGroupsFacetSorts = new HashMap();
