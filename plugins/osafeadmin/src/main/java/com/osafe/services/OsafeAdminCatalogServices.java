...
public class OsafeAdminCatalogServices {
    ...
    public static Map<String, Object> createProductFeatureAppl(DispatchContext dctx, Map<String, ? extends Object> context)
    {
        ...
        try 
        {
        	GenericValue productFeatureAppl = delegator.findOne("ProductFeatureAppl", UtilMisc.toMap("productId", productId, "productFeatureId", productFeatureId, "fromDate", fromDate));
