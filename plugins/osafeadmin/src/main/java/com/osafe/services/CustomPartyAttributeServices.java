...
public class CustomPartyAttributeServices {
    ...
    public static Map<String, ?> getPartyCustomAttributeList(DispatchContext ctx, Map<String, ?> context) 
    {
    	...
    	String customPartyAttributeFilePath = FlexibleStringExpander.expandString(System.getProperty("ofbiz.home") + "/plugins/osafe/import/data/xml/CustomPartyAttributes.xml", null);
