...
public class Constants {
    ...
    public static final String CATEGORY_NAME_AR_DATA_KEY = "categoryNameAr";
    public static final String CATEGORY_NAME_FR_DATA_KEY = "categoryNameFr";
    public static final String CATEGORY_NAME_NL_DATA_KEY = "categoryNameNl";
    public static final String CATEGORY_DESC_DATA_KEY = "description";
    public static final String CATEGORY_DESC_AR_DATA_KEY = "descriptionAr";
    public static final String CATEGORY_DESC_FR_DATA_KEY = "descriptionFr";
    public static final String CATEGORY_DESC_NL_DATA_KEY = "descriptionNl";
    ...
    public static final String PRODUCT_NAME_AR_DATA_KEY = "productNameAr";
    public static final String PRODUCT_NAME_FR_DATA_KEY = "productNameFr";
    public static final String PRODUCT_NAME_NL_DATA_KEY = "productNameNl";
    public static final String PRODUCT_SALES_PITCH_DATA_KEY = "salesPitch";
    public static final String PRODUCT_SALES_PITCH_AR_DATA_KEY = "salesPitchAr";
    public static final String PRODUCT_SALES_PITCH_FR_DATA_KEY = "salesPitchFr";
    public static final String PRODUCT_SALES_PITCH_NL_DATA_KEY = "salesPitchNl";
    public static final String PRODUCT_LONG_DESC_DATA_KEY = "longDescription";
    public static final String PRODUCT_LONG_DESC_AR_DATA_KEY = "longDescriptionAr";
    public static final String PRODUCT_LONG_DESC_FR_DATA_KEY = "longDescriptionFr";
    public static final String PRODUCT_LONG_DESC_NL_DATA_KEY = "longDescriptionNl";
    public static final String PRODUCT_SPCL_INS_DATA_KEY = "specialInstructions";
    public static final String PRODUCT_SPCL_INS_AR_DATA_KEY = "specialInstructionsAr";
    public static final String PRODUCT_SPCL_INS_FR_DATA_KEY = "specialInstructionsFr";
    public static final String PRODUCT_SPCL_INS_NL_DATA_KEY = "specialInstructionsNl";
    public static final String PRODUCT_DELIVERY_INFO_DATA_KEY = "deliveryInfo";
    public static final String PRODUCT_DELIVERY_INFO_AR_DATA_KEY = "deliveryInfoAr";
    public static final String PRODUCT_DELIVERY_INFO_FR_DATA_KEY = "deliveryInfoFr";
    public static final String PRODUCT_DELIVERY_INFO_NL_DATA_KEY = "deliveryInfoNl";
    ...
    public static final String PRODUCT_TERMS_COND_AR_DATA_KEY = "termsConditionsAr";
    public static final String PRODUCT_TERMS_COND_FR_DATA_KEY = "termsConditionsFr";
    public static final String PRODUCT_TERMS_COND_NL_DATA_KEY = "termsConditionsNl";
    public static final String PRODUCT_INGREDIENTS_DATA_KEY = "ingredients";
    public static final String PRODUCT_INGREDIENTS_AR_DATA_KEY = "ingredientsAr";
    public static final String PRODUCT_INGREDIENTS_FR_DATA_KEY = "ingredientsFr";
    public static final String PRODUCT_INGREDIENTS_NL_DATA_KEY = "ingredientsNl";
    public static final String PRODUCT_WARNING_DATA_KEY = "warnings";
    public static final String PRODUCT_WARNING_AR_DATA_KEY = "warningsAr";
    public static final String PRODUCT_WARNING_FR_DATA_KEY = "warningsFr";
    public static final String PRODUCT_WARNING_NL_DATA_KEY = "warningsNl";
