...
<#if mode?has_content>
  ...
  <#if mode="edit">
	    ...
	    <#assign carrierShipmentMethod = delegator.findOne("CarrierShipmentMethod", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("shipmentMethodTypeId", shipCharge.shipmentMethodTypeId!, "partyId", shipCharge.partyId!, "roleTypeId", "CARRIER"))/>
  </#if>
