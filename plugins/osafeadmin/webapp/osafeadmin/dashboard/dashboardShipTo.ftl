            ...
            <tr class="even">
              <#if periodRecTrendRange?exists>
                ...
                <#if periodFromRecTrendTs?has_content>
                  <#assign periodFrom = periodFromRecTrendTs?string("dd/MM/yyyy hh:mm")/>
                </#if>
                <#if periodToRecTrendTs?has_content>
                  <#assign periodTo = periodToRecTrendTs?string("dd/MM/yyyy hh:mm")/>
                </#if>
            ...
            <tr class="odd">
              <#if periodPriorTrendRange?exists>
                ...
                <#if periodFromPriorTrendTs?has_content>
                  <#assign periodFrom = periodFromPriorTrendTs?string("dd/MM/yyyy hh:mm")/>
                </#if>
                <#if periodToPriorTrendTs?has_content>
                  <#assign periodTo = periodToPriorTrendTs?string("dd/MM/yyyy hh:mm")/>
                </#if>
