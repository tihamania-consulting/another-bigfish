  ...
  <#if resultList?exists && resultList?has_content>
    ...
    <#list resultList as result>
      ...
      <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
        ...
        <td class="actionCol">
        <#assign productLongDescription = productContentWrapper.get("LONG_DESCRIPTION", "html")!""/>
        ...
        <td class="dateCol <#if !hasNext?if_exists>lastRow</#if>">${(product.introductionDate?string("dd/MM/yyyy hh:mm"))!""}</td>
        <td class="dateCol <#if !hasNext?if_exists>lastRow</#if>">${(product.salesDiscontinuationDate?string("dd/MM/yyyy hh:mm"))!""}</td>
                 ...
                 <#elseif (product.productTypeId?if_exists == 'FINISHED_GOOD') && (product.isVirtual?if_exists == 'N') && (product.isVariant?if_exists == 'N')>
                  ...
                  <#if (product.productTypeId?if_exists == 'FINISHED_GOOD') && (product.isVirtual?if_exists == 'N')>
                    ...
                    <#if product.introductionDate?has_content>
                      ...
                      <#assign introductionDate = (introDate)?string("dd/MM/yyyy hh:mm")>
                    ...
                    <#if product.salesDiscontinuationDate?has_content>
                      ...
                      <#assign salesDiscontinuationDate = (discDate)?string("dd/MM/yyyy hh:mm")>
