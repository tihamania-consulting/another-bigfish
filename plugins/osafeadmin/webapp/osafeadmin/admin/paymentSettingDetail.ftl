        ...
        <div class="infoEntry long">
            ...
            <div class="infoValue">
                ...
                <#elseif mode?has_content && mode == "edit">
                    <#assign paymentServiceTypeEnum = delegator.findOne("Enumeration", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("enumId", parameters.paymentServiceTypeEnumId!productStorePaymentSetting.paymentServiceTypeEnumId!""))?if_exists />
    ...
    <div class="infoRow row">
        <div class="infoEntry long">
            ...
            <div class="infoValue">
                ...
                <#elseif mode?has_content && mode == "edit">
                    <#assign paymentMethodType = delegator.findOne("PaymentMethodType", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("paymentMethodTypeId", parameters.paymentMethodTypeId!productStorePaymentSetting.paymentMethodTypeId!""))?if_exists />
