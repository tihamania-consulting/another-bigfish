...
<#escape x as x?xml>
    ...
    <#assign orderHeader = delegator.findOne("OrderHeader",Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("orderId",orderId))/>
    ...
    <#if invoiceId?has_content>
        <#assign invoice = delegator.findOne('Invoice', {"invoiceId" : invoiceId})!"" />
    </#if>
                	         ...
                	         <fo:table-column column-number="3" column-width="15mm"/>
                                 ...
                                 <fo:table-cell >
                                    <fo:block font-size="10pt" text-indent="1mm">
                                        ...
                                        <#assign weightUom = delegator.findOne('Uom', {"uomId" : shipmentPackage.weightUomId!})!"" />
                                ...
                                <fo:table-cell >
								   <#assign dimensionUom = delegator.findOne('Uom', {"uomId" : shipmentPackage.dimensionUomId!})!"" />
	                ...
	                <fo:table-body border-bottom-style="solid" border-top-style="solid" border-end-style="solid" border-start-style="solid" font-size="10pt">
	                  ...
	                  <#list package as line>
	                        ...
	                        <#if orderShipments?has_content>
	                          ...
	                          <#if orderItemBillings?has_content>
	                              <#assign orderItemBilling =  Static["org.apache.ofbiz.entity.util.EntityUtil"].getFirst(orderItemBillings) />
	                              <#assign invoiceItem = delegator.findOne('InvoiceItem', {"invoiceId" : invoiceId,"invoiceItemSeqId", orderItemBilling.invoiceItemSeqId!})!"" />
	                          </#if>
	                        </#if>
