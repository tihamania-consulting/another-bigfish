        ...
        <div class="infoEntry">
            ...
            <div class="infoValue">
                    ...
                    <#if orderItemShipGroup.carrierPartyId?has_content>
		                <#assign carrier =  delegator.findOne("PartyGroup", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", orderItemShipGroup.carrierPartyId))?if_exists />
    ...
    <div class="infoRow row">
        <div class="infoEntry">
            ...
            <div class="infoValue">
	      <#assign contactMech = delegator.findOne("ContactMech", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechId", orderItemShipGroup.contactMechId))?if_exists />
