<#if parameters.organizationCustomerPartyId?has_content>
    <tr class="dataRow odd">
        ...
        <#assign person = delegator.findOne("Person", {"partyId", parameters.organizationCustomerPartyId})/>
        <#assign party = delegator.findOne("Party", {"partyId", parameters.organizationCustomerPartyId})/>
