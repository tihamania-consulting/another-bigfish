...
<div class="entryRow">
  <div class="entry daterange">
    ...
    <div class="entryInput from">
      <input class="dateEntry" type="text" name="contactUsDateFrom" maxlength="40" value="${parameters.contactUsDateFrom!periodFrom!nowTimestamp?string('dd/MM/yyyy')!""}"/>
    </div>
    <label class="tolabel">${uiLabelMap.ToCaption}</label>
    <div class="entryInput to">
      <input class="dateEntry" type="text" name="contactUsDateTo" maxlength="40" value="${parameters.contactUsDateTo!periodTo!nowTimestamp?string('dd/MM/yyyy')!""}"/>
    </div>
  </div>
</div>
<div class="entryRow">
