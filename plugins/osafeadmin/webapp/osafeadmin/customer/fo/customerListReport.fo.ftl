...
>
  ...
  <#if customerList?has_content>
   <#list customerList as partyrow>
    ...
    <#assign party =   delegator.findOne("Party",Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId))/>
    ...
    <#-- Personal info --> 
    <#assign emailPreference = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","PARTY_EMAIL_PREFERENCE"))!""/>
   ...
   <#if partyContactMechPurpose?has_content> 
    ...
    <#if typeId?has_content && typeId=="PERSON">
      ...
      <#assign partyGroup =   delegator.findOne("PartyGroup",Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",payToPartyId))/>
      ...
      <#if selAddresses?has_content>
        <#assign companyAddress = delegator.findOne("PostalAddress", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechId",selAddresses[0].contactMechId))/>
      ...
      <#if selPhones?has_content>
        ...
        <#assign companyPhone = delegator.findOne("TelecomNumber", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechId",selPhones[0].contactMechId))/>
      </#if>
      ...
      <#if selEmails?has_content>
        ...
        <#assign companyEmail = delegator.findOne("ContactMech",Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("contactMechId",selEmails[0].contactMechId))/>
      </#if>
      <#-- Company Website -->
      ...
      <#-- Personal info --> 
      <#assign title = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","TITLE"))!""/>
      <#if title?has_content>
          <#assign title = title.attrValue!"" >
      </#if>

      <#assign gender = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","GENDER"))!""/>
      <#if gender?has_content>
			  <#assign gender = gender.attrValue!"" >
	  </#if>
	  
	  <#assign dob_MMDD = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","DOB_MMDD"))!""/>
	  <#if dob_MMDD?has_content>
			  <#assign dob_MMDD = dob_MMDD.attrValue!"" >
	  </#if>
	  
	  <#assign dob_MMDDYYYY = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","DOB_MMDDYYYY"))!""/>
	  <#if dob_MMDDYYYY?has_content>
			  <#assign dob_MMDDYYYY = dob_MMDDYYYY.attrValue!"" >
	  </#if>

      <#assign dob_DDMM = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","DOB_DDMM"))!""/>
      <#if dob_DDMM?has_content>
              <#assign dob_DDMM = dob_DDMM.attrValue!"" >
      </#if>
      
      <#assign dob_DDMMYYYY = delegator.findOne("PartyAttribute", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId",partyId,"attrName","DOB_DDMMYYYY"))!""/>
