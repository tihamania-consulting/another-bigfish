        ...
        <#if resultList?exists && resultList?has_content  && !parameters.totalRows?exists>
            <#list resultList as partyRow>
                  ...
                  <tr class="dataRow <#if rowClass == "2">even<#else>odd</#if>">
                   ...
                   <#assign person = delegator.findOne("Person", {"partyId", partyRow.partyId})/>
                   <#assign party = delegator.findOne("Party", {"partyId", partyRow.partyId})/>
			        ...
			        <td class="typeCol">
			            <#if partyRoleTypeId?has_content>
			                <#assign roleType = delegator.findOne("RoleType", {"roleTypeId", partyRoleTypeId})/>
			            </#if>
            ...
            <#if (minRow?exists && minRow &gt; 0) >
                <#list 1..minRow as x>
                    ...
                    <tr class="dataRow <#if rowClass?if_exists == "2">even<#else>odd</#if>">
				        ...
				        <#assign person = delegator.findOne("Person", {"partyId", organizationEmployeeId})/>
				        <#assign party = delegator.findOne("Party", {"partyId", organizationEmployeeId})/>
				        <#assign downloadStatus = "">
