<table class="osafe">
  ...
  <#if (shoppingCart.size() > 0)>
    ...
    <#list productPromoCodesEntered.iterator() as productPromoCodeEntered>
      <#assign productPromoCode = delegator.findOne("ProductPromoCode", {"productPromoCodeId" : productPromoCodeEntered})/>
        ...
        <tr>
          <td class="idCol firstCol">
            ...
            <#elseif productPromoUseInfo.productPromoId?has_content>
              <#assign productPromo = delegator.findOne("ProductPromo", {"productPromoId" : productPromoUseInfo.productPromoId})/>
