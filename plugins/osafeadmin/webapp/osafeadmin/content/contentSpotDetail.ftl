	    ...
	    <div class="infoRow CONTEXT_FILE">
	   		<div class="infoEntry long">
     		    ...
     		    <div class="infoIcon">
     		        ...
     		        <#assign tooltipData = Static["org.apache.ofbiz.base.util.UtilProperties"].getMessage("OSafeAdminUiLabels", "FileReferenceContentHelpInfo", Static["org.apache.ofbiz.base.util.UtilMisc"].toList("${ofbizHome}/plugins/osafe/webapp/osafe"), locale)/>
