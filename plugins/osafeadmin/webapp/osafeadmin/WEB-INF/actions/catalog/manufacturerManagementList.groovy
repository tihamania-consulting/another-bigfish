...
List<GenericValue> completePartyList = new ArrayList();
List<GenericValue> matchNamePartyList = new ArrayList();
if(UtilValidate.isNotEmpty(preRetrieved) && preRetrieved != "N") 
{
	 ...
	 if(UtilValidate.isNotEmpty(partyName))
	 {
		 ...
		 {
			 party = delegator.findOne("Party",UtilMisc.toMap("partyId",foundParty.partyId));
