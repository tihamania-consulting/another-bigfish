...
if (UtilValidate.isNotEmpty(custRequestList)) 
{
    ...
    for(GenericValue custRequest : custRequestList)
    {
        ...
        custReqAttribute = delegator.findOne("CustRequestAttribute",UtilMisc.toMap("custRequestId", custRequestId,"attrName","IS_DOWNLOADED"));
        ...
        custReqAttribute = delegator.findOne("CustRequestAttribute",UtilMisc.toMap("custRequestId", custRequestId,"attrName","DATETIME_DOWNLOADED"));
