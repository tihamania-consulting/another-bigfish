...
//TOP PRODUCTS
    ...
    //FieldsToSelect
    List topProductFields = new ArrayList();
    ...
    List <GenericValue> topProductsList  = new ArrayList();
    Map<String, GenericValue> allTopProductsMap = new HashMap();
    ...
    if (UtilValidate.isNotEmpty(topProductsList))
    {
        ...
        topProductContentWrappers = new HashMap();
    ...
    List <GenericValue> storePickupTopProductsList  = new ArrayList();
    allTopProductsMap = new HashMap();
    ...
    if (UtilValidate.isNotEmpty(storePickupTopProductsList))
    {
        ...
        storePickupTopProductContentWrappers = new HashMap();
...
//TOP PROMOTIONS
    ...
    //FieldsToSelect
    List topPromotionFields = new ArrayList();
