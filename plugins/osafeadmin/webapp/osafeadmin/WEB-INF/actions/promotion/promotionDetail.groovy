...
if (UtilValidate.isNotEmpty(productPromotionId))
{
    ...
    productPromo = delegator.findOne("ProductPromo", [productPromoId : productPromotionId]);
...
if (UtilValidate.isNotEmpty(productPromoId))
{
    ...
    productPromo = delegator.findOne("ProductPromo", [productPromoId : productPromoId]);
    context.productPromo = productPromo;
