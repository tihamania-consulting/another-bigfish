...
productFeatureList = new ArrayList();
if (UtilValidate.isNotEmpty(parameters.featureTypeId)) 
{
	...
	productFeatureType = delegator.findOne("ProductFeatureType", UtilMisc.toMap("productFeatureTypeId", featureTypeId));
...
productFeatureSearchList=new ArrayList();
