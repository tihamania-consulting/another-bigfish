...
productSearchByCategoryList = new ArrayList();
...
if(UtilValidate.isNotEmpty(searchText))
{
	...
	completeDocumentList = new ArrayList();
...
else
{
	...
	//FieldsToSelect
	List productFields = new ArrayList();
	...
	prodCtntExprDesc = new ArrayList();
	prodCtntExprName = new ArrayList();
	...
	if (UtilValidate.isNotEmpty(description))
	{
		...
		productIdListDesc = new ArrayList();
	...
	if (UtilValidate.isNotEmpty(productName))
	{
		...
		productIdListName = new ArrayList();
