...
pendingOneToFiveReviews = new ArrayList();
pendingSixToTenReviews= new ArrayList();
pendingElevenToTwentyReviews = new ArrayList();
pendingTwentyPlusReviews = new ArrayList();
resultList = new ArrayList();
dateCond = null;
statusCond = null;
mainCond = null;
