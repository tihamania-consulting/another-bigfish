...
List<String> orderStatusIds = new ArrayList();
...
if(UtilValidate.isNotEmpty(orderStatusIncSearch))
{
    ...
    {
        statusItem = delegator.findOne("StatusItem", UtilMisc.toMap("statusId", orderStatus.trim()));
        statusDescription = "";
...
{
	List<String> lProductStoreId = new ArrayList();
...
List orderContactMechIds = new ArrayList();
