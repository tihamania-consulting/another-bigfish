...
if (UtilValidate.isNotEmpty(svcCtx)) 
{
    ...
    if (UtilValidate.isNotEmpty(orderPDFList)) 
    {
        ...
        Map<String, Object> upOrderHeaderCtx = new HashMap();
        ...
        for(GenericValue orderHeader : orderPDFList) 
        {
            ...
            Map<String, Object> isDownloadedOrderAttrCtx = new HashMap();
            ...
            Map<String, Object> dateTimeDownloadedOrderAttrCtx = new HashMap();
			...
			List orderAdjustmentsSalesTax = new ArrayList();
