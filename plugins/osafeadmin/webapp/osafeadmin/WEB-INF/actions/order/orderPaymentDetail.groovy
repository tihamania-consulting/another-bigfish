...
if(UtilValidate.isNotEmpty(orderId))
{
    List summaryPaymentInfo = new ArrayList();
    ...
    if(UtilValidate.isNotEmpty(context.orderPaymentPreferenceId))
    {
        ...
        orderPaymentPreference = delegator.findOne("OrderPaymentPreference",UtilMisc.toMap("orderPaymentPreferenceId",paymentPrefId));
