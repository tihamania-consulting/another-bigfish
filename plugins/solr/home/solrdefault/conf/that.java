...
<tokenizer class="solr.StandardTokenizerFactory"/>
<filter class="solr.StopFilterFactory" ignoreCase="true" words="stopwords.txt"/>
<filter class="solr.ShingleFilterFactory" outputUnigrams="true" maxShingleSize="4"/>
<filter class="solr.LowerCaseFilterFactory"/>
<filter class="solr.RemoveDuplicatesTokenFilterFactory"/>
</analyzer>
</fieldType>
...
<field name="productCategoryId" type="text_ws" indexed="true" stored="true" required="false"/>
<field name="topMostProductCategoryId" type="text_ws" indexed="true" stored="true" required="false"/>
...
<field name="productImageSmallAlt" type="string" indexed="false" stored="true" required="false"/>
<field name="productImageSmallAltUrl" type="string" indexed="false" stored="true" required="false"/>
...
<field name="sequenceNum" type="string" indexed="true" stored="true" required="false"/>
<field name="totalTimesViewed" type="long" indexed="true" stored="true" required="false"/>
<field name="totalQuantityOrdered" type="float" indexed="true" stored="true" required="false"/>
<field name="introductionDate" type="date" indexed="true" stored="true" required="false" datetimeformat="yyyy-MM-dd'T'HH:mm:sss'Z'"/>
<field name="salesDiscontinuationDate" type="date" indexed="true" stored="true" required="false" datetimeformat="yyyy-MM-dd'T'HH:mm:sss'Z'"/>
<field name="salesDiscontinuationDateNullFlag" type="int" indexed="true" stored="true" required="false"/>
<field name="manufacturerName" type="string" indexed="true" stored="true" required="false"/>
<field name="manufacturerIdNo" type="string" indexed="true" stored="true" required="false"/>
...
<field name="productCategoryFacetGroups" type="text_ws" indexed="true" stored="true" required="false" omitNorms="true"/>
<!-- fields for finding product facility location Region  -->
<field name="productFacilityIds" type="string" indexed="true" stored="true" required="false"/>
...
<dynamicField name="*" type="text_ws" indexed="true" stored="true" required="false" multiValued="true" omitNorms="true"/>
...
<copyField source="productId" dest="searchText"/>
...
<copyField source="categoryName" dest="searchText"/>
<copyField source="price" dest="searchText"/>
<copyField source="*" dest="searchText"/>

<copyField source="name" dest="autocomplete_text"/>
<copyField source="internalName" dest="autocomplete_text"/>
<copyField source="description" dest="autocomplete_text"/>
<copyField source="categoryName" dest="autocomplete_text"/>
<copyField source="categoryDescription" dest="autocomplete_text"/>
<copyField source="manufacturerName" dest="autocomplete_text"/>

<copyField source="name" dest="spell"/>
<copyField source="internalName" dest="spell"/>
<copyField source="description" dest="spell"/>
<copyField source="categoryName" dest="spell"/>
<copyField source="categoryDescription" dest="spell"/>
</schema>
<?xml version="1.0" encoding="UTF-8" ?>
<!--
 Licensed to the Apache Software Foundation (ASF) under one or more
