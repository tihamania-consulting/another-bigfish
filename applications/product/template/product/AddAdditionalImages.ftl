...
<#if product?has_content>
  <#assign productAdditionalImage1 = (Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(product, "ADDITIONAL_IMAGE_1", locale, dispatcher, "string"))! />
  <#assign productAdditionalImage2 = (Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(product, "ADDITIONAL_IMAGE_2", locale, dispatcher, "string"))! />
  <#assign productAdditionalImage3 = (Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(product, "ADDITIONAL_IMAGE_3", locale, dispatcher, "string"))! />
  <#assign productAdditionalImage4 = (Static["org.apache.ofbiz.product.product.ProductContentWrapper"].getProductContentAsText(product, "ADDITIONAL_IMAGE_4", locale, dispatcher, "string"))! />
</#if>
